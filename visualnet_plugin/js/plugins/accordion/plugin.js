...
(function ()
{
		...
		init: function (editor)
		{
			...
			editor.addCommand('addAccordionCmd', {
				...
				exec: function (editor)
				{
					var dl = new CKEDITOR.dom.element.createFromHtml (
						...
						'<dt>' + Drupal.t('Accordion title') + ' 1</dt>' +
						'<dd><p>' + Drupal.t('Accordion content') + ' 1</p></dd>' +
						'<dt>' + Drupal.t('Accordion title') + ' 2</dt>' +
						'<dd><p>' + Drupal.t('Accordion content') + ' 2</p></dd>' +
						'</dl>');
			...
			editor.addCommand('addAccordionTabBefore', {
				...
				exec: function (editor)
				{
					...
					var newHeader  = new CKEDITOR.dom.element.createFromHtml ('<dt>' + Drupal.t('New accordion title') + '</dt>');
					var newContent = new CKEDITOR.dom.element.createFromHtml ('<dd><p>' + Drupal.t('New accordion content') + '</p></dd>');
	...
	CKEDITOR.dtd.$removeEmpty.dl = 0;
	CKEDITOR.dtd.$removeEmpty.dt = 0;
	CKEDITOR.dtd.$removeEmpty.dd = 0;
